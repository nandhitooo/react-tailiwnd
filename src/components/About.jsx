    ...
    >
      ...
      >
        ...
        <p className="mt-15 text-xl text-gray-300">
          ...
          with attention to structure, responsiveness, and usability. I improve
        ...
        <button
          className="mt-10 px-6 py-3 bg-yellow-400 text-black font-semibold rounded-lg hover:bg-yellow-500 hover:scale-105 transition-all duration-300 cursor-pointer"
          onClick={() =>
            window.open(
